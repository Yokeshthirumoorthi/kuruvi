...
const QUEUE_SERVICE = process.env.QUEUE_SERVICE;
const QUEUE_PORT = process.env.QUEUE_PORT;
const QUEUE_ENDPOINT = `${QUEUE_SERVICE}:${QUEUE_PORT}`;
...
const FACE_DESCRIBE_SERVICE = process.env.FACE_DESCRIBE_SERVICE;
const FACE_DESCRIBE_PORT = process.env.FACE_DESCRIBE_PORT;
const FACE_DESCRIBE_ENDPOINT = `${FACE_DESCRIBE_SERVICE}:${FACE_DESCRIBE_PORT}`;
...
const PGSQL_DGRAPH = process.env.PGSQL_DGRAPH;
const PGSQL_DGRAPH_PORT_2 = process.env.PGSQL_DGRAPH_PORT_2;
const PGSQL_DGRAPH_ENDPOINT = `${PGSQL_DGRAPH}:${PGSQL_DGRAPH_PORT_2}`;
...
module.exports = {
    QUEUE_SERVICE, QUEUE_PORT, QUEUE_ENDPOINT,
    ...
    FACE_DESCRIBE_SERVICE, FACE_DESCRIBE_PORT, FACE_DESCRIBE_ENDPOINT,
    ...
    PGSQL_DGRAPH, PGSQL_DGRAPH_PORT_2, PGSQL_DGRAPH_ENDPOINT,
    PGSQL_USERNAME, PGSQL_PASSWORD, PGSQL_DB,
